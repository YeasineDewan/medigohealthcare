          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <div className="bg-white rounded-xl border-2 border-gray-200 p-6 shadow-lg">
                ...
                <div className="space-y-3">
                  <Link to="/health-cards/premium/apply" className="w-full flex items-center justify-between p-3 rounded-lg bg-amber-50 text-amber-700 hover:bg-amber-100 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/health-cards/premium/apply" className="px-8 py-4 bg-white text-amber-600 font-semibold rounded-full hover:bg-gray-100 transition-all duration-300 hover:scale-105 shadow-lg">
                Apply Now
              </Link>
              <a
                href="tel:+1234567890"
