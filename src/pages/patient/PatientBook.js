...
const specialtyLookup = specialties.reduce((acc, specialty) => {
  acc[specialty.id] = specialty.name.toLowerCase();
  return acc;
}, {});
...
export default function PatientBook() {
  ...
  const filteredDoctors = doctors.filter(doc => {
    ...
    const selectedSpecialtyName = selectedSpecialty ? specialtyLookup[selectedSpecialty] : null;
    const matchesSpecialty = !selectedSpecialtyName || doc.specialty.toLowerCase() === selectedSpecialtyName;
