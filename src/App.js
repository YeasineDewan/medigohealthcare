...
import HealthCardApply from './pages/HealthCardApply';
...
import DoctorsManagement from './pages/admin/doctors/DoctorsManagement.js';
import PatientsManagement from './pages/admin/patients/PatientsManagement.js';
...
import PrescriptionManagement from './pages/admin/pharmacy/PrescriptionManagement';
...
function App() {
    ...
    <BrowserRouter>
      ...
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="health-cards/:cardType/apply" element={<HealthCardApply />} />
        </Route>
        ...
        {/* Admin Dashboard */}
        <Route path="/admin" element={<ProtectedRoute allowedRoles={['admin']}><ProfessionalAdminLayout /></ProtectedRoute>}>
          ...
          <Route path="pharmacy/prescription-management" element={<PrescriptionManagement />} />
  ...
  <Route path="/patient/advanced" element={<ProtectedRoute allowedRoles={['patient']}><AdvancedPatientLayout /></ProtectedRoute>}>
