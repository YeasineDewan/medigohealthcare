...
import { Star, MapPin, Clock, Heart, Calendar, Phone, Shield } from 'lucide-react';
import Card from '../core/Card';
import { useState } from 'react';

export default function DoctorCard({ doctor }) {
  const [isFavorited, setIsFavorited] = useState(false);
  const { id, name, specialty, rating, reviewCount, location, available, image, consultationFee } = doctor;
